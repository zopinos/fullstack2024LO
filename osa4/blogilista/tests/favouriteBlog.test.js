...
describe('favourite blog', () => {
    ...
    const listWithTwoFavouriteBlogs = [
        {
            _id: "5a422a851b54a676234d17f7",
            title: "React patterns",
            author: "Michael Chan",
        ...
        {
            _id: "a676234d17f95a422b3a1b54",
            title: "Some other favourite blog",
    ...
    test('when multiple favourite blogs are present, both are fine to be returned', () => {
        const result = listHelper.favouriteBlog(listWithTwoFavouriteBlogs)

        const reference = ["5a422b3a1b54a676234d17f9", "a676234d17f95a422b3a1b54"]

        assert.strictEqual(reference.includes(result._id, 0), true)
    })
})