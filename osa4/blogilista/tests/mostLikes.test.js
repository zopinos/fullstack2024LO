...
describe('most likes', () => {
    ...
    test('of a bigger list is found right', () => {
        const result = listHelper.mostLikes(edsgerBest)
    ...
    test('when multiple liked authors are present, both are fine to be returned', () => {
        ...
        const reference = ["Edsger W. Dijkstra", "Robert C. Martin"]

        assert.strictEqual(reference.includes(result.author, 0), true)
    })
})